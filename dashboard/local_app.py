...
from components.callbacks.local.airplane_cb import update_airplanes_callback
from components.callbacks.local.airports_cb import update_airports_callback, update_airport_callback
from components.callbacks.local.schedule_cb import update_schedule_callback, update_schedules_callback
from components.callbacks.local.graphs_cb import airplanes_graph, schedules_graph, airports_graph
from components.callbacks.local.maps_cb import create_map
